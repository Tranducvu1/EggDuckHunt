...
function updateDuckInPondSprite(duck: Duck, duckElement: HTMLImageElement): void {
    ...
    if (!duck.relaxState || duck.relaxState === 0) {
        duckElement.src = facingRight ? "../assets/duck/relax-red/a3.png" : "../assets/duck/relax-red/a1.png";
    } else if (duck.relaxState === 1) {
        duckElement.src = facingRight ? "../assets/duck/relax-red/a5.png" : "../assets/duck/relax-red/a7.png";
    } else if (duck.relaxState === 2) {
        duckElement.src = facingRight ? "../assets/duck/relax-red/a6.png" : "../assets/duck/relax-red/a8.png";
    }
}
...
function updateDuckSprite(duck: Duck, duckElement: HTMLImageElement): void {
    ...
    if (Math.random() < 0.1) { // Only update sprite 10% of the time
        duckElement.src = `../assets/duck/right-left-red/a${duck.frame + (duck.direction.x < 0 ? 2 : 0)}.png`;
