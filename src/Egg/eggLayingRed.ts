...
function animateDuckToBasket(
  ...
  duckElement.src = `../assets/duck/right-left-red/a${initialDirection > 0 ? 1 : 3}.png`;
...
function updateMovingDuckSprite(duck: Duck, duckElement: HTMLImageElement, startPosition: Position): void {
  ...
  duckElement.src = `../assets/duck/right-left-red/a${duck.frame + (currentDirection === -1 ? 2 : 0)}.png`;
